...
export const ADMIN_SIDENAV_ITEMS: SideNavItem[] = [
   ...
   {
      title: "Applications",
      path: "/dashboard/admin/student-applications",
   ...
   },
   {
      ...
      submenuItems: [
         ...
         { title: "Department", path: "/dashboard/admin/course-management/department" },
         { title: "Courses", path: "/dashboard/admin/course-management/courses" },
         { title: "Course Categories", path: "/dashboard/admin/course-management/course-categories" },
         { title: "Courses Assignment", path: "/dashboard/admin/course-management/course-assignment" },
      ],
   },
   {
...
export const STUDENT_SIDENAV_ITEMS: SideNavItem[] = [
   ...
   {
      title: "Application",
      path: "/dashboard/student/complete-application",
      icon: "AcademicCapIcon",
   },
   {
      title: "Acceptance",
      path: "/dashboard/student/acceptance",
...
export const State: any[] = [
   ...
   { id: 35, label: "Federal Capital Territory", value: "Federal Capital Territory Statae" },
]
