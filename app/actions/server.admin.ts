...
const fetchFacultyAndDepartments = async () => {
   ...
   if (success?.data) {
      for (const faculty of success.data) {
         const { error, success }: any = await GetAllDepartmentInAFaculty(faculty.id);
         if (success?.data) {
...
export async function CreateNewFaculty(token: string, data: Omit<Faculty, 'id'>) {
   const response = await apiCallerBeta({
...
export async function UpdateSingleFaculty(id: string, token: string, data: Partial<Faculty>) {
   const response = await apiCallerBeta({
...
export async function CreateNewDepartment(token: string, data: Omit<Department, 'id'>) {
   const response = await apiCallerBeta({
...
export async function UpdateSingleDepartment(id: string, token: string, data: Partial<Department>) {
   const response = await apiCallerBeta({
...
export async function UpdateSingleCourse(id: string, token: string, data: Partial<Course>) {
   const response = await apiCallerBeta({
...
export async function UpdateSingleCourseCategory(id: string, token: string, data: Partial<CourseCategory>) {
   const response = await apiCallerBeta({
...
export async function CreateNewCourseCategory(token: string, data: Omit<CourseCategory, 'id' | 'short_code'>) {
   const response = await apiCallerBeta({
...
export async function CreateNewCourseAssignment(token: string, data: Omit<CourseAssignment, 'id'>) {
   const response = await apiCallerBeta({
...
export async function GetAllCoursesInACategory(short_code: string, token: string) {
...
export async function GetListOfCountries() {
   ...
   return {
      error: null, success: [
         {
            id: "1", name: "Nigeria", parent: 1,
            description: "description "
         },
         {
            id: "2", name: "Ghana", parent: 1,
            description: "description "
         },
         {
            id: "3", name: "South Africa", parent: 1,
            description: "description "
         },
      ]
   }
...
export async function UpdateSingleCountry(token: string, data: Partial<Country>) {
   // const response = await apiCallerBeta({
   //    url: `${remoteApiUrl}/admin/reject-application`,
   //    method: 'POST',
   // data: { ...data },
...
export async function CreateNewCountry(token: string, data: Omit<Country, 'id'>) {
   // const response = await apiCallerBeta({
   //    url: `${remoteApiUrl}/admin/reject-application`,
   //    method: 'POST',
   // data: { ...data },
...
export async function GetListOfStates(token: string) {
   const response = await apiCallerBeta({
...
export async function GetSingleState(id: string, token: string) {
   ...
   if (response.success.data) {
      const state = response.success.data.find((state: any) =>
         state.id === Number(id));
...
export async function UpdateSingleState(id: string, token: string, data: Partial<State>) {
   const response = await apiCallerBeta({
...
export async function GetListOfLocalGov(token: string) {
   const response = await apiCallerBeta({
...
export async function GetSingleLocalGov(id: string, parentId: string, token: string) {
   let response = await apiCallerBeta({
   ...
   if (response.success.data) {
      const lga = response.success.data.find((lga: any) =>
         lga.id === Number(id));
...
export async function UpdateSingleLocalGov(id: string, token: string, data: Partial<LocalGov>) {
   data.lga = data.name;
   const response = await apiCallerBeta({
...
export async function CreateNewLocalGov(token: string, data: Omit<LocalGov, 'id'>) {
...
export async function UpdateSingleClassSubjects(token: string, data: Partial<CLassSubject>) {
   // const response = await apiCallerBeta({
   //    url: `${remoteApiUrl}/admin/reject-application`,
   //    method: 'POST',
   // data: { ...data },
...
export async function CreateNewClassSubjects(token: string, data: Omit<CLassSubject, 'id'>) {
   // const response = await apiCallerBeta({
   //    url: `${remoteApiUrl}/admin/reject-application`,
   //    method: 'POST',
   // data: { ...data },
...
export async function UpdateSingleSubjectGrade(token: string, data: Partial<SubjectGrade>) {
   // const response = await apiCallerBeta({
   //    url: `${remoteApiUrl}/admin/reject-application`,
   //    method: 'POST',
   // data: { ...data },
...
export async function CreateNewSubjectGrade(token: string, data: Omit<SubjectGrade, 'id'>) {
   // const response = await apiCallerBeta({
   //    url: `${remoteApiUrl}/admin/reject-application`,
   //    method: 'POST',
   // data: { ...data },
