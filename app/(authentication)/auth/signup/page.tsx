...
export default function AdminLoginPage() {
    ...
    return (
        <div className={cn(`block w-full space-y-4 md:space-y-6 text-left`)}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className={cn(`space-y-4 max-h-[400px] overflow-y-scroll`)}>
                <FormFieldSet legend={'Personal Information'} classList={`bg-white border-0 pr-10 ${
                    step == 0 ? "block" : "hidden"
                  }`} >
